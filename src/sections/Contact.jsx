...
external: true,
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
        <path d="M4 6h6a3 3 0 0 1 0 6H4zM4 12h6.5a3 3 0 0 1 0 6H4z" strokeLinejoin="round" />
        <path d="M14.5 14.5h6a3 3 0 0 0-6 0 3 3 0 0 0 5.4 1.8M16 8h5" strokeLinecap="round" />
      </svg>
    ),
  },
  {
      ...
      <div className="wrap">
        ...
        <ul className="contact__grid">
          {ACTIONS.map((a) => {
            ...
            return (
              <li key={a.id}>
                <Magnetic strength={0.14} className="contact__magnet">
                  <Wrap className={`contact__card ${a.primary ? 'is-primary' : ''}`}>
                    <a
                      href={a.href}
                      ...
                      data-cursor="link"
                    >
                      <span className="contact__icon">{a.icon}</span>
                      <span className="contact__body">
                        <span className="contact__label">
                          {a.primary ? <ShinyText speed={4}>{a.label}</ShinyText> : a.label}
                        </span>
                        <span className="contact__value">{a.value}</span>
                      </span>
